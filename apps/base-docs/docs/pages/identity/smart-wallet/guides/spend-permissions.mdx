...
<GithubRepoCard title="Spend Permissions Demo" githubUrl="https://github.com/base/demos/tree/master/smart-wallet/spend-permissions-demo" />
...
Add a new file called `SpendPermissionManager.ts` and copy and paste the code from [this file](https://github.com/base/demos/blob/master/smart-wallet/spend-permissions-demo/lib/abi/SpendPermissionManager.ts).
